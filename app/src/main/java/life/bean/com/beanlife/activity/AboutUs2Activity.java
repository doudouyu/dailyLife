...
public class AboutUs2Activity extends BaseActivity {
    ...
    private MyTextView common_problem;
    private MyTextView check_update;
    private MyTextView recommend_friend;
    private MyTextView about_us;

    @Override
    public int getLayoutId() {
        return R.layout.layout_about_us2;
    }
    ...
    public void initView() {
        ...
        common_problem = (MyTextView) findViewById(R.id.common_problem);
        check_update = (MyTextView) findViewById(R.id.check_update);
        recommend_friend = (MyTextView) findViewById(R.id.recommend_friend);
        about_us = (MyTextView) findViewById(R.id.about_us);
    }
    ...
    public void onInnerClick(View v) {
        ...
        Intent intent = new Intent(AboutUs2Activity.this, AboutUsDetailActivity.class);
        switch (v.getId()) {
